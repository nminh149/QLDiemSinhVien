...
- Đảm bảo các file chính nằm trong cùng một Console Application: Menu.cs, QuanLyDiemMonHoc.cs, DiemMonHoc.cs, File.cs
...
1. Sau khi khởi động, chương trình hiển thị Menu chính với các chức năng được đánh số từ 0 đến 8.
2. Người dùng chỉ cần nhập số tương ứng để sử dụng chức năng mong muốn.
...
3. Khi thoát chương trình, hệ thống sẽ hỏi người dùng có lưu dữ liệu hay không nhằm tránh mất thông tin.
